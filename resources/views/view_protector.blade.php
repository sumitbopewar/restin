...
@section('content')
    <div class="main_card container">
        <div class="product-card " style="position:relative;">
            <div id="carouselExampleRide" class="carousel slide _slider" data-bs-ride="true">
                <div class="carousel-inner">
                    <div class="carousel-item active caro-img">
                        <div class="zoom-container">
                            <img src="{{ asset('storage/images/' . $protector_detail->image1) }}" class="d-block w-100 car-img"
                                alt="...">
                            <div class="zoomed-image">
                                <img src="{{ asset('storage/images/' . $protector_detail->image1) }}" alt="Zoomed Image">
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item caro-img">
                        <div class="zoom-container">
                            <img src="{{ asset('storage/images/' . $protector_detail->image2) }}" class="d-block w-100 car-img"
                                alt="...">
                            <div class="zoomed-image">
                                <img src="{{ asset('storage/images/' . $protector_detail->image2) }}" alt="Zoomed Image">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="asdf">
                    <img src="{{ asset('storage/images/' . $protector_detail->image1) }}"
                    ...
                    <img src="{{ asset('storage/images/' . $protector_detail->image2) }}" class="d-block target-img block_img"
            ...
            <div class="_content mt-5 mt-lg-0 mt-md-0 pt-5 pt-lg-0 pt-md-0">
                ...
                <form action="/cart_data" method="POST">
                    ...
                    <h2 class="product-title fw-bold">{{$protector_detail->product}}</h2>
                    {{-- product price --}}
                    ...
                    <div class="card-input">
                        ...
                        <div class="inpt">
                            <label for="protector_category" class="form-label">Category</label>
                            <select class="form-select protector_category" aria-label="Default select example"
                                id="protector_category" name="protector_category" data-product-name="" required>
                        ...
                        <div class="inpt">
                            <label for="protector_size" class="form-label">Size</label>
                            <select class="form-select protector_size" aria-label="Default select example"
                                id="protector_size" name="size_id" data-product-name="" required>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.protector_category').change(function() {
                let pcat = $(this).val();
                
                console.log(pcat);

                $.ajax({
                    url: '/get_protector_category',
                    type: 'GET',
                    data: {
                        'pcat': pcat,
                    },
                    ...
                    success: function(result) {
                        ...
                        var productSizeSelect = $('.protector_size');
                       ...
                       $.each(result, function(key, value) {
                                ...
                                optionText + '</option><input type="hidden" name="unit_id" value="'+value[0].unit+'"><input type="hidden" name="Size_id" value="'+optionValue+'">');
                            });
                        }
                });
            ...
            $('.protector_size').change(function() {
                size_id = $(this).val();
                let pcat = $('.protector_category').val();
                // console.log(size_id);
                // console.log(pcat);

                $.ajax({
                    url: '/get_protector_size',
                    type: 'GET',
                    data: {
                        'size_id': size_id,
                        'pcat': pcat,
                    ...
                    success: function(result) {
                        ...
                        $.each(result, function(key, value) {
                            ...
                            '"><input type="hidden" name="master_size_id" value="'+value.category+'"><input type="hidden" name="protector_id" value="'+value.id+'">');
                        });
                    },
