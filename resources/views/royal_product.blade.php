...
@section('content')
    <h2 class=" text-center home_mattress_head text-dark" style="background-image: url('https://restin.in/layouts/img/New_Royale Header (1).png');background-size: 100% 100%;height: 420px;margin-top:0px;">  </h2>


    <div class="main_card container" style=" margin-top: 1rem; background: #fff;">
