...
<div class="container content_container">
    ...
    <div class="contents">
        ...
        <p class="mb-5">The difference between quality mattresses and less expensive mattresses includes features that you can visibly see and other features that are not visible. One can see the difference with the mattress top, the height of a mattress and the outer fabric; however you can’t see the construction materials used underneath the top layer. It’s a combination of all you can and can’t see, that make for a quality mattress. All these factors help determine the durability and firmness along with the overall comfort level a mattress can provide.</p>

        <h3 class="mb-5" style="font-family: Courier New;">For choosing the right mattress you can do the SLEEP test</h3>
        ...
        <div class="mb-5" style="margin: auto; display: flex; justify-content: center;">
            <img src="{{asset('layouts/img/htc-img01.jpg')}}" alt="">
        </div>

        <p class="mb-3">The following chart shows that Waist, Shoulders & Hips constitute 2/3 of the body weight while sleeping. These parts are provided extra cushioning to ensure proper body support.</p>
        <p class="mb-5">Restin Mattresses are designed to support body weight so that the Person is put to maximum ease and comfort while sleeping.</p>

        <div class="mb-5" style="margin: auto; display: flex; justify-content: center;">
            <img src="{{asset('layouts/img/htc-img2.jpg')}}" alt="">
        </div>
