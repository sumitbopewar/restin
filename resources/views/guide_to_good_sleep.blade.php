...
<div class="container p2 page2">
    <div>
        ...
        <p style="text-align: justify">When we sleep, our body restore, rejuvenate, and regenerate it is a time to recover from the previous day
    ...
    <div class="parent-content row" style="margin-top: 30px;">
        ...
        <div class="sub-content col-lg-6" style="margin-top: 25px;">
            ...
            <div>
                ...
                <p style="text-align: justify">When it comes to getting adequate sleep, six hours of uninterrupted sleep is better than eight or
        ...
        <div class="p col-lg-6" style="margin: auto;">
            <img class="para-img img-fluid" src="{{asset('layouts/img/Para-img.jpg')}}" alt="" style="padding: 0px; margin:20px; height:360px; width:100%">
        </div>
