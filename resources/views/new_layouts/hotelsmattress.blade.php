...
@section('content')
 ...
 <!-- Page Header Start -->
    ...
    <!-- Page Header End -->
    <!-- <img src="{{asset('layouts/img/New_Hotel Mattress.png')}}" alt="" class="img-fluid"> -->
        ...
        <div class="container">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-sm-12">
                                <p>When we sleep, our body restore, rejuvenate, and regenerate it is a time to recover from the previous day while repairing and preparing for the next. Adequate sleep reduces stress and illness, balances our emotions, and improves our overall well being. Sleep helps us conserve our energy resources to ensure maximum performance throughout the day.</p>
                            </div>
                        </div>
                        <h2 class="mb-5">Benefits of Getting Good Sleep</h2>
                        <div class="row g-4 mb-4">
                ...
                <div class="col-lg-6">
                    <div class="row g-3">
                        <div class="col-6 text-end">
                            <img class="img-fluid w-75 wow zoomIn" data-wow-delay="0.1s" src="https://images.pexels.com/photos/879010/pexels-photo-879010.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" style="margin-top: 25%;">
                        </div>
                        <div class="col-6 text-start">
                            <img class="img-fluid w-100 h-100 wow zoomIn object-fit-cover" data-wow-delay="0.3s" src="{{asset('layouts/img/getting_good_to_sleep.jpg')}}">
                        </div>
                        <div class="col-6 text-end">
                            <img class="img-fluid w-50 wow zoomIn" data-wow-delay="0.5s" src="https://images.pexels.com/photos/7018391/pexels-photo-7018391.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2">
                        </div>
                        <div class="col-6 text-start">
                            <img class="img-fluid w-75 wow zoomIn" data-wow-delay="0.7s" src="https://images.pexels.com/photos/3768891/pexels-photo-3768891.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row g-5 align-items-center mt-1">
                <div class="col-lg-6">
                    <div class="row g-3">
                        <div class="col-6 text-end">
                            <img class="img-fluid w-75 wow zoomIn" data-wow-delay="0.1s" src="https://images.pexels.com/photos/6585601/pexels-photo-6585601.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" style="margin-top: 25%;">
                        </div>
                        <div class="col-6 text-start">
                            <img class="img-fluid w-100 h-100 wow zoomIn object-fit-cover" data-wow-delay="0.3s" src="https://images.pexels.com/photos/879010/pexels-photo-879010.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2">
                        </div>
                        <div class="col-6 text-end">
                            <img class="img-fluid w-50 wow zoomIn" data-wow-delay="0.5s" src="https://images.pexels.com/photos/7018391/pexels-photo-7018391.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2">
                        </div>
    ...
    <div class="we-help-section p-0">
        <div class="container">
	        <!-- <div class="row justify-content-between align-items-center py-2 px-0">
		        <div class="col-lg-6 mb-5 mb-lg-0">
                    <img class="para-img img-fluid" src="{{asset('layouts/img/getting_good_to_sleep.jpg')}}" alt="" style="width:100%;">
		        </div>
		        <div class="col-lg-6 ps-lg-5">
                <h2 class="section-title mb-4 w-100">Benefits of Getting Good Sleep</h2>
            <p>
    ...
    <!-- <div class="row justify-content-between my-3">
        ...
        <h2 class="section-title mb-4 w-100">How do you know When It's Time for a New Mattress ?</h2>
            <p>
            Don't look at your warranty to tell you how long to keep your mattress. The warranty on a mattress is not an indicator of how long the product should be used before replacement. Normally, a mattress provides optimum service for about six to eight years of nightly use. If your mattress is no longer comfortable or supportive, and you're waking up tired, stiff, cranky, and with aching muscles and joints, it could be time for a new mattress.
            </p>
           </div>
           <div class="col-lg-6 ps-lg-6">
        <h2 class="section-title mb-4 w-100">Health Benefits of a Quality Mattress</h2>
            <p>
    ...
    <div class="row justify-content-between">
		...
		<div class="col-lg-5 ps-lg-5">
           ...
           <img src="{{asset('layouts/img/mattress size chart.png')}}" class="product_img p-0 img-fluid" alt="Pillow img">
		</div>
    </div>
		...
		<div class="col-lg-12 ps-lg-5">
			...
			<p>
			One of the most important factors to achieve a better night's sleep is a comfortable amount of space. Generally, a mattress should be longer and wider than the amount of space you and your partner uses to sleep. The following sizes area general guide to help you make a better decision.
           </p>
		</div>
    ...
    <div class="row justify-content-between my-5">
		...
		<div class="col-lg-5 ps-lg-5">
            ...
            Easy to carry as it is on wheels with mattress of 6" attached to it. Length 78*36(1980*913 mm), Height 18"(460mm), Color:Black.
           </p>
           <div class="row">
            <style>
                .img1,.img2{
            ...
            <div class="col-lg-6"><img src="{{asset('layouts/img/image 2.jpg')}}" alt="" class="img1"></div>
            <div class="col-lg-6"><img src="{{asset('layouts/img/image 1.jpeg')}}" alt="" class="img2"></div>
           </div>
           <p>
