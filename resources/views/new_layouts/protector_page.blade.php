...
<div class="container">
	<div class="row justify-content-between">
		<div class="col-lg-7 mb-5 mb-lg-0">
          <p>
              Mattress Protector extends the life of your mattress. This will not change the feel of your mattress and provides comfort as it naturally absorbs moisture. 100% waterproof with airflow technology allows air to circulate through the protector, but repels liquids.
          </p>
          <p>
              Protects Mattress against allergens, dust mites, bacteria, perspiration, urine and fluids. Ideal for use when putting infants to bed to protect your mattress against bed wetting.
          </p>
          <p>
              Mattress Protector is made of <strong>Water proof, Dustproof fabric</strong> with the Top Surface of Premium Terry cloth with TPU coating on the back.
          </p>
          <p>
              <strong>PERFECT FIT:</strong> Fits your mattress of 78×72-inch size with thickness up to 10″ (skirting provided up to 18 “). Available in all sizes. Can be custom made also.
          </p>
          <p>
              <strong>EASY TO CLEAN:</strong> Machine washable, which adds the convenience of washing and drying easily. Use mild detergent and cold wash. While drying, keep the Terry Side up.
          </p>
		</div>
...
<div class="container">
    ...
    <div class="col-lg-5 ps-lg-5 text-center">
            ...
            <img src="{{asset('layouts/img/protector_icons-removebg-preview.png')}}" class="img-fluid ps-0 my-4">
		</div>
