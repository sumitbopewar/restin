            ...
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body px-0 pt-0 py-2">
                        <form class="px-5" action="insertMM" method="POST">
                            @csrf
                            <div class="d-flex">
                            ...
                            <div class="d-flex">
                                <div class="mb-3 mx-3 w-50">
                                    ...
                                    <input type="text" class="form-control" name="mm_length" id="mm_length" required>
                                </div>
                                <div class="mb-3 mx-3 w-50">
                                    <label for="mm_breath" class="form-label">Breath in MM</label>
                                    <input type="text" class="form-control" name="mm_breath" id="mm_breath" required>
                                </div>
                            </div>
                            <div class="d-flex">
                                <div class="mb-3 mx-3 w-50">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($sizemm as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $units->unit }}</td>
                                            @endif
                                            <td>{{ $item['mm_length'] }}</td>
                                            <td>{{ $item['mm_breath'] }}</td>
                                            <td>{{ $item['status'] }}</td>
                                            <td class="align-middle">
                                                <a href="{{ url('mm/edit/' . $item->id) }}"
                                                    class="badge btn btn-success">Edit</a>
                                                <a href="{{ url('mm/delete/' . $item->id) }}"
