            ...
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body px-0 pt-0 py-2">
                        <form class="px-5" action="insertHomeMattress" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="d-flex">
                                    ...
                                    @foreach ($homemat as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <a href="{{ url('home_mattress/edit/' . $item->id) }}"
                                                    class="badge btn btn-success">Edit</a>
                                                <a href="{{ url('home_mattress/delete/' . $item->id) }}"
