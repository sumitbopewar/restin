            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h6>Add Master Size</h6>
                    </div>
                    <div class="card-body px-0 pt-0 py-2">
                        <form class="px-5" action="insertMsize" method="POST">
                            @csrf
                            <div class="d-flex">
                                <div class="mb-3 mx-3 w-50">
                                    <label for="size_name" class="form-label">Master Size</label>
                            ...
                            <table class="table align-items-center mb-0" id="myTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-uppercase">Size Name</th>
                                    ...
                                    @foreach ($msize as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle"> 
                                                <a href="{{ url('msize/delete/' . $item->id) }}" onclick="return confirm('Are you sure you want to delete this Size?')">
