            ...
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body px-0 pt-0 py-2">
                        <form class="px-5" action="insertHospitalMattress" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="d-flex">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($hospitalmat as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $item['price'] }}</td>
                                            <td><img src="{{ asset('storage/images/' . $item->image) }}" alt="product not found" style="width:50px!important;height:50px!important;" class="rounded-0">
                                            </td>
                                            <td>{{ $item['status'] }}</td>
                                            <td class="align-middle">
                                                <a href="{{ url('hospital_mattress/edit/' . $item->id) }}"
                                                    class="badge btn btn-success">Edit</a>
                                                <a href="{{ url('hospital_mattress/delete/' . $item->id) }}"
