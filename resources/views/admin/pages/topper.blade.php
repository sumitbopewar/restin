            ...
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body px-0 pt-0 py-2">
                        <form class="px-5" action="/insert_topper" method="POST"  enctype="multipart/form-data">
                            @csrf
                            <div class="d-flex">
                                        ...
                                        <tr>
                                           ...
                                           <td><img src="{{ asset('storage/images/' . $item->image2) }}"
                                            ...
                                            <td class="align-middle">
                                                <a href="{{ url('topper/edit/' . $item->id) }}"
                                                    class="badge btn btn-success">Edit</a>
                                                <a href="{{ url('topper/delete/' . $item->id) }}"
                                                    onclick="return confirm('Are you sure you want to delete this topper?')">
