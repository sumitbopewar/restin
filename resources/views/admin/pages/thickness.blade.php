            ...
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body px-0 pt-0 py-2">
                        <form class="px-5" action="insertThickness" method="POST">
                            @csrf
                            <div class="d-flex">
                                <div class="mb-3 mx-3 w-50">
                                    <label for="thickness" class="form-label">Thickness </label>
                                    <input type="text" class="form-control" name="thickness" id="thickness" required>
                                </div>
                                <div class="mb-3 mx-3 w-50">
                            ...
                            <table class="table align-items-center mb-0" id="myTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-uppercase">Thickness Size </th>
                                    ...
                                    @foreach ($thickness as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle"> 
                                                <a href="{{ url('thickness/delete/' . $item->id) }}" onclick="return confirm('Are you sure you want to delete this Thickness?')">
