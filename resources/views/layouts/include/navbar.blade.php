<nav class="navbar navbar-expand-lg navbar-light fixed-top shadow p-0" style="background-color:#deeefa">
    <div class="container-fluid px-5 mx-5">
        <a class="navbar-brand" href="#"><img src="{{ asset('/layouts/img/logo.png') }}" width="100px"
                alt="logo"></a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav mb-2 mb-lg-0 gap-4">
                ...
                <li class="nav-item">
                    <a class="nav-link fw-bold  {{ request()->is('/') ? 'active_page' : ''}}" aria-current="page" href="{{route('home')}}">Home</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link fw-bold {{ request()->is('guide_to_good_sleep') ? 'active_page' : ''}}" href="{{route('guide_to_good_sleep')}}">Guide To Good Sleep</a>
                </li>

                <li class="nav-item dropdown">
                    <a class="nav-link fw-bold dropdown-toggle {{ request()->is('homemattress') || request()->is('hospital') || request()->is('hotel') ? 'active_page' : '' }}" href="#" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        Mattress
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link fw-bold {{ request()->is('royal') ? 'active_page' : ''}}" href="{{route('royal')}}">Royal Mattress</a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link fw-bold {{ request()->is('contact') ? 'active_page' : ''}}" href="{{route('contact')}}">Contact</a>
                </li>

                <li class="align-self-center">
                    <a href="{{route('cart')}}"><i class="bi bi-cart3 text-dark"><sup class="badge bg-danger">1</sup></i>
